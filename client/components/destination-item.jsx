  ...
  return (
    ...
    <div className="card destination-item h-50 mt-3" style={{ backgroundImage: `url(${destination.destinationImage})` }}>
      ...
      <div className="row justify-content-center px-3">
        ...
        }}className="cursor-pointer mt-2 circle circle-dest-list teal p-2 mr-1 d-flex text-center w-25 text-dark">
          <i className="fas fa-pen icon"></i>
        </Link>
        <div className="cursor-pointer mt-2 circle circle-dest-list red p-2 ml-1 d-flex text-center w-25">
