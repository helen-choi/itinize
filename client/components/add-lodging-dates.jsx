    ...
    return (
      <div className="add-lodging-number-container">
        ...
        <div className="checkin row justify-content-center mt-5">
          ...
          <input type="date" name="checkinDate" min={todayFormatted} max={this.state.checkoutTime} value={this.state.checkinDate} onChange={this.handleChange}/>
        ...
        <div className="checkout row justify-content-center mt-5">
          ...
          <input type="date" name="checkoutDate" min={checkOutMin} value={this.state.checkoutDate} onChange={this.handleChange} />
